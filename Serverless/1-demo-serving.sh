...
########################
. ./demo-master.sh
DEMO_PROMPT="${GREEN}pops-MBP-2:os-demos popsjoshi$  ${BLACK}"
clear
...
pe "for i in {1..5} ; do curl http://greeter-amexdemo.apps.cluster-86ec.86ec.sandbox1639.opentlc.com; sleep .05 ; done"
...
pe "kn service update greeter \
  ...
  --traffic=\"latest=0\""
pe "kn revision list --namespace amexdemo-2"
pe "for i in {1..10} ; do curl http://greeter-amexdemo-2.apps.cluster-86ec.86ec.sandbox1639.opentlc.com; sleep .05 ; done"
#pe "oc get ksvc greeter -o yaml \
# | yq r - 'status.traffic[*].url'"
pe "kn service update greeter \
  --traffic=\"v1=80\" \
  --traffic=\"v2=20\"  \
  --traffic=\"latest=0\""
pe "for i in {1..50} ; do curl http://greeter-amexdemo-2.apps.cluster-86ec.86ec.sandbox1639.opentlc.com; sleep .05 ; done"
pe "kn service create prime-generator \
  --concurrency-target=10 \
  --image=quay.io/rhdevelopers/prime-generator:v27-quarkus"
#pe "watch 'kubectl get pods -n amexdemo-2'"
pe "hey -c 50 -z 10s \
  \"http://prime-generator-amexdemo-2.apps.cluster-86ec.86ec.sandbox1639.opentlc.com/?sleep=3&upto=10000&memload=100\""
